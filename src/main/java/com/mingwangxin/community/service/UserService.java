...
import com.mingwangxin.community.dao.LoginTicketMapper;
import com.mingwangxin.community.dao.UserMapper;
...
import com.mingwangxin.community.util.MailClient;
...
public class UserService implements CommunityConstant {
    ...
    public Map<String, Object> register(User user) {
        ...
        //
        user.setHeaderUrl(String.format("http://image.nowcoder.com/dead/%dt.png", new Random().nextInt(1000)));
